...
useSeoMeta({
  title: t('app.tool.socialEngineeringDictGen.label'),
})
...
<template>
  <ToolContainer>
    <UAlert class="mb-4" icon="i-tabler-clipboard-text"
            title="所有项目都是选填，将已有的信息全部填入即可，尽量减少无效输入"/>
    <UAlert class="mb-4" icon="i-solar-shield-minimalistic-bold-duotone" color="primary" variant="subtle"
            title="不用担心"
